...
public class NotebookRequest extends CustomComponent {
	...
	private Map<Integer, String> notebooks;
	...
	public NotebookRequest() {
		...
		control = new NotebookRequestController();

		notebooks = control.getNotebooks();
		addNotebookOptions();

		lecturers = new String[3];
		lecturers[0] = "One";
		lecturers[1] = "Two";
		lecturers[2] = "Seventeen";
		setLecturer(lecturers);

		operatingSystems = new String[0];
	}
	...
	private void addNotebookOptions() {
		for (Integer notebookID : notebooks.keySet()) {
			Item i = notebookOptionGroup.addItem(notebookID);
			notebookOptionGroup.setItemCaption(i, notebooks.get(notebookID));
		}
	}
