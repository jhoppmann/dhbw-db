...
public class NotebookRequest extends CustomComponent {
	...
	public NotebookRequest() {
		...
		// TODO Add these 3 Methods to the MainController class: getNotebooks(),
		// getLecturers(), getOperatingSystems()

		// notebooks = ((MainUI)
		// (MainUI.getCurrent())).getController().getNotebooks();
		// lecturers = ((MainUI)
		// (MainUI.getCurrent())).getController().getLecturers();
		// operatingSystems = ((MainUI)
		// (MainUI.getCurrent())).getController().getOperatingSystems();
	 ...
	 * @param notebooks
	 */
	private void setNotebook(String[] notebooks) {
		for (int i = 0; i < notebooks.length; i++) {
			if (notebooks[i] != null) {
				notebookOptionGroup.addItem(notebooks[i]);
			}
		}
	}
	 ...
	 */
	private void setOS(String[] operatingSystems) {
		for (int i = 0; i < operatingSystems.length; i++) {
			if (operatingSystems[i] != null) {
				oSComboBox.addItem(operatingSystems[i]);
			}
		}
	}
	 ...
	 * @param lecturers
	 */
	private void setLecturer(String[] lecturers) {
		for (int i = 0; i < lecturers.length; i++) {
			if (lecturers[i] != null) {
				lecturerComboBox.addItem(lecturers[i]);
			}
		}
	}
