/**
 * LecturerAllRequestsPage.java Created by Yannic Frank on 15.03.2013
 */
...
/**
 * The LecturerAllRequestsPage shows all requests of a lecturer stored in the
 * database
 * 
 * @author Yannic Frank
 * @version 0.1
 * @since
 */
public class LecturerAllRequestsPage extends CustomComponent {
	 ...
	 */
	public LecturerAllRequestsPage() {
		buildMainLayout();
