/**
 * AdminApprovedRequestsPage.java Created by Yannic Frank on 15.03.2013
 */
...
/**
 * The adminApprovedRequestsPage shows all approved requests.
 * 
 * @author Yannic Frank
 * @version 0.1
 * @since
 */
public class AdminApprovedRequestsPage extends CustomComponent {
	 ...
	 */
	public AdminApprovedRequestsPage() {
		buildMainLayout();
	...
	private VerticalLayout buildpanelLayout() {
		...
		for (Request rq : allRequests) {
			if (rq.getStatus() == Status.APPROVED)
				openRequests.add(rq);
		}
		// detailTable
